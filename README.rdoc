...
For Redmine 1.x use https://github.com/pvgladkov/redmine_kanbanery/tree/redmine1x

== Setup
Run:
  $ cd redmine/plugins 
  $ git clone https://github.com/pvgladkov/redmine_kanbanery.git
...
Для Redmine 1.x используйте https://github.com/pvgladkov/redmine_kanbanery/tree/redmine1x
